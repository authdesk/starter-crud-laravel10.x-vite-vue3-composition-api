$(function () {
  ...
  var geographicMap = jQuery('#geographic-map-2');

  if (geographicMap.length > 0) {

    geographicMap.vectorMap(
      {
        map: 'world_mill_en',
  ...
  var chartElement = document.getElementById("chart3");
  ...
  var chartElement = document.getElementById("chart4");
  ...
  var chartElement = document.getElementById("chart5");
